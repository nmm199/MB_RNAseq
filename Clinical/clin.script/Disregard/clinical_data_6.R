...
### Date: July 19 2017
### this file was created by modifying clinical_data_4.R, then clinical_data_4_update.R
...
source (file = "/home/nmm199/R/MB_RNAseq/Clinical/clin.script/clinical_data_functions_v3.R")
...
### return list to be used to assess each goi
print(result.goi)
