...
histo.p.adj.km.OS.SHH <- hist(adjusted.p.km.OS.SHH)
histo.p.adj.km.OS.SHH.old <- hist(adjusted.p.km.OS.SHH.old)
...
histo.p.adj.km.PFS.SHH <- hist(adjusted.p.km.PFS.SHH)
histo.p.adj.km.PFS.SHH.old <- hist(adjusted.p.km.PFS.SHH.old)
...
cox.PFS.cont.HR.all <- lapply (results.master, extract.cox.PFS.cont.HR)
...
cox.L95CI.PFS.cont.HR.all <- lapply (results.master, extract.cox.cont.L95CI.HR)
...
cox.U95CI.PFS.cont.HR.all <- lapply(results.master, extract.function.cont)

cox.PFS.cont.all.df <- cox.dataframe(pval = cox.PFS.cont.pval.all, Zscore = cox.PFS.cont.Zscore.all, HR = cox.PFS.cont.HR.all, L95CI = cox.L95CI.PFS.cont.HR.all, U95CI = cox.U95CI.PFS.cont.HR.all)

colnames(cox.PFS.cont.all.df) <- c("cox.PFS.pval.cont.all", "cox.PFS.adj.pval.cont.all", "cox.PFS.Zscore.cont.all", "cox.PFS.HR.cont.all", "cox.PFS.L95CI.cont.all", "cox.PFS.U95CI.cont.all")
