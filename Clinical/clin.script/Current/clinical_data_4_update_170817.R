...
source (file = "/home/nmm199/R/MB_RNAseq/Clinical/clin.script/clinical_data_functions_v2.R")
...
#goi <- "ENSG00000136997"
goi <- "ENSG00000001084.10_2"  ### attempting to clarify the outputs for the current file biomarker_assess 
...
### this may be the best place to add in cytogenetic q13 data TBC
