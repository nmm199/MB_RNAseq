...
### if workflow interrupted, save and reload phast.cons, long processing time
# saveRDS(phast.cons, file = "/home/nmm199/R/MB_Data/phast.cons.rds")
### reload
# readRDS("/home/nmm199/R/MB_Data/phast.cons.rds")
...
save(phast.window,file = "/home/nmm199/R/MB_Data/phast.window.Rdata")
...
### loading in all of the data, note /home/nmm199/R/MB_Data
...
write.table(cbind(total.counts, subgroup.counts), file = "./novel_trans/counts.table.novel.trans.txt", sep = "\t")
...
pdf(file = "./venn.diagram.novel.trans.pdf")
